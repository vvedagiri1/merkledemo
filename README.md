...
## Environments
- Preview: https://main--merkledemo--vvedagiri1.aem.page/
- Live: https://main--merkledemo--vvedagiri1.aem.live/
...
1. Open the `merkledemo` directory in your favorite IDE and start coding :)
